...
const zh: Record<string, string> = {
  ...
  'session.history': '對話記錄', 'session.empty': '還沒有儲存的對話', 'session.untitled': '新對話',
  ...
  'connection.title': 'AI 連線', 'connection.help': '每家服務只要開啟或登入一次；外掛會持續使用你選定的真實分頁。', 'connection.connected': '就緒', 'connection.checking': '檢查中', 'connection.login': '請登入', 'connection.open': '開啟', 'targets.title': '傳送給',
