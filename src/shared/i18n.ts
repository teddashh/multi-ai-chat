...
const en: Record<string, string> = {
  ...
  'settings.meta_permission_denied': 'Meta AI needs access to meta.ai. Access was not granted, so Meta AI stays on standby.',
...
const zh: Record<string, string> = {
  ...
  'settings.meta_permission_denied': 'Meta AI 需要存取 meta.ai。未授予存取權，因此 Meta AI 維持備用。',
...
const ja: Record<string, string> = {
  ...
  'settings.meta_permission_denied': 'Meta AI には meta.ai へのアクセスが必要です。アクセスが許可されなかったため、Meta AI は待機のままです。',
  ...
  'app.subtitle': '1つの質問、4つの視点', 'app.connected': '準備完了', 'app.export': '書き出し', 'app.publish': '公開', 'app.settings': '設定', 'app.menu': '会話履歴', 'app.new': '新しい会話', 'app.close': '閉じる', 'session.history': '会話履歴', 'session.empty': '保存された会話はありません', 'session.untitled': '新しい会話', 'session.delete': '削除',
  'settings.title': '設定', 'settings.language': '言語', 'settings.theme': '表示モード', 'settings.theme.system': 'システムに従う', 'settings.theme.light': 'ライト', 'settings.theme.dark': 'ダーク', 'settings.hackmd.label': 'HackMD API トークン', 'settings.hackmd.help': '任意。トークンの作成：', 'settings.hackmd.local': '信頼された拡張機能ページだけに保存されます。公開するとゲスト閲覧可能な HackMD ノートになります。', 'settings.about': '情報', 'settings.save': '保存', 'settings.cancel': 'キャンセル', 'settings.clear': 'トークンを削除',
  ...
  'error.input_not_found': '{provider} の入力欄が見つかりません',
  'error.input_injection_failed': '{provider} に入力できませんでした：{detail}',
  'error.input_disappeared': '送信確認の前に {provider} の入力欄が消えました',
  'error.send_failed': '{provider} に送信できませんでした：{detail}',
  'error.send_rejected': '{provider} はこのメッセージを受け付けませんでした。下書きは入力欄に残っています',
  'error.no_response_text': '{provider} は応答テキストを返しませんでした',
  'error.response_in_progress': '{provider} はすでに応答を作成中です',
  'error.empty_message': 'メッセージが空です',
  'error.not_ready': '{provider} の準備ができていません',
  'error.navigated_away': '{provider} はワークフロー中にページを離れました',
  'error.reloaded': '{provider} はワークフロー中に再読み込みされました',
  'error.tab_closed': '{provider} のタブはワークフロー中に閉じられました',
  'error.timeout': '{provider} は {seconds} 秒以内に応答しませんでした',
  'error.recovery_timeout': '{provider} のエラーに対する選択がなかったため、ワークフローを停止しました',
  'error.no_target': '選択した AI はどれも準備ができていません',
  'error.worker_stopped': 'ブラウザがワークフロー中に拡張機能のワーカーを停止しました。このステップを再実行してください。',
  'error.hackmd_failed': 'HackMD {status}：{detail}',
  'error.hackmd_no_link': 'HackMD の応答に公開リンクがありません',
...
const de: Record<string, string> = {
  ...
  'settings.meta_permission_denied': 'Meta AI benötigt Zugriff auf meta.ai. Der Zugriff wurde nicht gewährt, daher bleibt Meta AI inaktiv.',
  ...
  'app.subtitle': 'Eine Frage, vier Perspektiven', 'app.connected': 'bereit', 'app.export': 'Exportieren', 'app.publish': 'Veröffentlichen', 'app.settings': 'Einstellungen', 'app.menu': 'Unterhaltungen', 'app.new': 'Neuer Chat', 'app.close': 'Schließen', 'session.history': 'Gesprächsverlauf', 'session.empty': 'Noch keine gespeicherten Gespräche', 'session.untitled': 'Neues Gespräch', 'session.delete': 'Löschen',
  'settings.title': 'Einstellungen', 'settings.language': 'Sprache', 'settings.theme': 'Darstellung', 'settings.theme.system': 'System', 'settings.theme.light': 'Hell', 'settings.theme.dark': 'Dunkel', 'settings.hackmd.label': 'HackMD-API-Token', 'settings.hackmd.help': 'Optional. Token erstellen unter', 'settings.hackmd.local': 'Nur in vertrauenswürdigen Erweiterungsseiten gespeichert. Beim Veröffentlichen entsteht eine für Gäste lesbare HackMD-Notiz.', 'settings.about': 'Über', 'settings.save': 'Speichern', 'settings.cancel': 'Abbrechen', 'settings.clear': 'Token löschen',
  ...
  'error.input_not_found': 'Das Eingabefeld von {provider} wurde nicht gefunden',
  'error.input_injection_failed': 'Konnte nicht in {provider} eingeben: {detail}',
  'error.input_disappeared': 'Das Eingabefeld von {provider} ist vor der Sende-Bestätigung verschwunden',
  'error.send_failed': 'Konnte nicht an {provider} senden: {detail}',
  'error.send_rejected': '{provider} hat die Nachricht nicht übernommen; der Entwurf bleibt im Eingabefeld',
  'error.no_response_text': '{provider} hat keinen Antworttext erzeugt',
  'error.response_in_progress': '{provider} arbeitet bereits an einer Antwort',
  'error.empty_message': 'Die Nachricht ist leer',
  'error.not_ready': '{provider} ist nicht bereit',
  'error.navigated_away': '{provider} hat die Seite während des Workflows verlassen',
  'error.reloaded': '{provider} wurde während des Workflows neu geladen',
  'error.tab_closed': 'Der Tab von {provider} wurde während des Workflows geschlossen',
  'error.timeout': '{provider} hat innerhalb von {seconds} Sekunden nicht geantwortet',
  'error.recovery_timeout': 'Für den Fehler von {provider} wurde keine Auswahl getroffen; der Workflow wurde gestoppt',
  'error.no_target': 'Keine der ausgewählten KIs ist bereit',
  'error.worker_stopped': 'Der Browser hat den Erweiterungs-Worker während dieses Workflows gestoppt. Bitte den Schritt erneut ausführen.',
  'error.hackmd_failed': 'HackMD {status}: {detail}',
  'error.hackmd_no_link': 'Der HackMD-Antwort fehlt ein Veröffentlichungslink',
...
const ko: Record<string, string> = {
  ...
  'settings.meta_permission_denied': 'Meta AI는 meta.ai 접근 권한이 필요합니다. 접근이 허용되지 않아 Meta AI는 대기 상태로 유지됩니다.',
  ...
  'app.subtitle': '하나의 질문, 네 가지 관점', 'app.connected': '준비됨', 'app.export': '내보내기', 'app.publish': '게시', 'app.settings': '설정', 'app.menu': '대화 기록', 'app.new': '새 대화', 'app.close': '닫기', 'session.history': '대화 기록', 'session.empty': '저장된 대화가 없습니다', 'session.untitled': '새 대화', 'session.delete': '삭제',
  'settings.title': '설정', 'settings.language': '언어', 'settings.theme': '표시 모드', 'settings.theme.system': '시스템 설정', 'settings.theme.light': '라이트', 'settings.theme.dark': '다크', 'settings.hackmd.label': 'HackMD API 토큰', 'settings.hackmd.help': '선택 사항. 토큰 만들기:', 'settings.hackmd.local': '신뢰된 확장 페이지에만 저장됩니다. 게시하면 게스트가 읽을 수 있는 HackMD 노트가 생성됩니다.', 'settings.about': '정보', 'settings.save': '저장', 'settings.cancel': '취소', 'settings.clear': '토큰 삭제',
  ...
  'roles.toggle.show': '역할 설정', 'roles.toggle.hide': '역할 닫기', 'role.pro': '찬성', 'role.con': '반대', 'role.judge': '판정', 'role.summary': '종합', 'role.first': '답변 A', 'role.second': '답변 B', 'role.reviewer': '검토', 'role.planner': '계획', 'role.coder': '구현', 'role.tester': '테스트', 'role.first_speaker': '첫 번째', 'role.second_speaker': '두 번째', 'role.third_speaker': '세 번째', 'role.fourth_speaker': '네 번째', 'connection.title': 'AI 연결', 'connection.help': '각 서비스를 한 번 열거나 로그인하세요. 선택한 실제 탭을 제어합니다.', 'connection.connected': '준비됨', 'connection.checking': '확인 중', 'connection.login': '로그인', 'connection.open': '열기', 'connection.connect_all': '모두 연결', 'targets.title': '전송 대상', 'trace.title': '워크플로', 'trace.idle': '다음 질문을 입력할 수 있습니다', 'chat.empty': '질문으로 시작하세요', 'chat.empty.help': '모드와 AI를 확인한 뒤 보내세요. 완료 후에도 같은 대화를 계속할 수 있습니다.', 'chat.typing': '답변 중…', 'chat.you': '나', 'chat.system': '시스템',
  ...
  'error.input_not_found': '{provider} 입력란을 찾을 수 없습니다',
  'error.input_injection_failed': '{provider}에 입력할 수 없습니다: {detail}',
  'error.input_disappeared': '전송이 확인되기 전에 {provider} 입력란이 사라졌습니다',
  'error.send_failed': '{provider}에 전송하지 못했습니다: {detail}',
  'error.send_rejected': '{provider}가 메시지를 받지 않았습니다. 초안은 입력란에 남아 있습니다',
  'error.no_response_text': '{provider}가 응답 텍스트를 만들지 않았습니다',
  'error.response_in_progress': '{provider}가 이미 응답을 작성 중입니다',
  'error.empty_message': '메시지가 비어 있습니다',
  'error.not_ready': '{provider}가 아직 준비되지 않았습니다',
  'error.navigated_away': '{provider}가 워크플로 중에 페이지를 떠났습니다',
  'error.reloaded': '{provider}가 워크플로 중에 다시 로드되었습니다',
  'error.tab_closed': '{provider} 탭이 워크플로 중에 닫혔습니다',
  'error.timeout': '{provider}가 {seconds}초 안에 응답하지 않았습니다',
  'error.recovery_timeout': '{provider} 오류에 대한 선택이 없어 워크플로가 중지되었습니다',
  'error.no_target': '선택한 AI가 모두 아직 준비되지 않았습니다',
  'error.worker_stopped': '브라우저가 워크플로 중에 확장 프로그램 워커를 중지했습니다. 이 단계를 다시 실행하세요.',
  'error.hackmd_failed': 'HackMD {status}: {detail}',
  'error.hackmd_no_link': 'HackMD 응답에 게시 링크가 없습니다',
